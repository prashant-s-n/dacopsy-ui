          ...
          <div className='grid grid-cols-12 mb-5 w-full items-center bg-white shadow-md p-3 rounded-xl'>
            ...
            <div className='col-span-8 p-8'>
              ...
              <div className='block p-3'>
                ...
                <br/><br/>
                {`DaCoPsy simplifies the data generating method by allowing you to automatically generate data within a given range.
                    The data generated can be further manipulated to get the desired level of significance, normality, skewness and many more.
